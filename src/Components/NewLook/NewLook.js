    ...
    return (
        <div className='md:flex md:justify-around mt-14'>
            <div className='md:w-2/4 ml-14'>
                <h1 className='md:text-3xl font-medium'> <span className='text-red-600 font-bold font-serif'>WELCOME</span> <span className='text-red-500 font-serif'>TO YOUR NEW SITES</span></h1>
                <p className='mt-8 font-sans '>Izmo Stock is sit amet, falli tollit cetero te eos. Ea ullum liber aperiri mi, impetus ate philosophia ad duo, quem regione ne ius. Vis quis lobortis dissentias ex, in du aft philosophia, malis necessitatibus no mei. Volumus sensibus qui ex, eum duis doming ad. Modo liberavisse eu mel, no viris prompta sit. Pro labore sadipscing et. Ne peax egat usu te mel vivendo scriptorem. Pro labore sadipscing et. Ne pertinax egat usu te mel vivendo scriptorem.</p>
